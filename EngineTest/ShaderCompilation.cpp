...
namespace {
    ...
    public:
        ...
        dxc_compiled_shader compile(shader_file_info info, std::filesystem::path full_path, vel::utl::vector<std::wstring>& extra_args)
        {
        ...
        dxc_compiled_shader compile(IDxcBlobEncoding* source_blob, vel::utl::vector<std::wstring> compiler_args)
        {
            DxcBuffer buffer{};
