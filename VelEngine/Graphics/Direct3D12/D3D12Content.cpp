...
namespace vel::graphics::d3d12::content
{
    namespace {
        ...
        D3D_PRIMITIVE_TOPOLOGY
            get_d3d_primitive_topology(vel::content::primitve_topology::type type)
        {
    ...
    namespace submesh {
        ...
        id::id_type add(const u8*& data)
        {
            ...
            view.primitive_topology = get_d3d_primitive_topology((vel::content::primitve_topology::type)primitive_topology);
