...
namespace vel::graphics::d3d12::fx {
    namespace {
        ...
        bool create_fx_pos_and_root_signature()
        {
            ...
            d3dx::d3d12_root_signature_desc root_signature
            {
                &parameters[0], _countof(parameters), d3dx::d3d12_root_signature_desc::default_flags,
